...
namespace spawndef {
    ...
    inline Entity SpawnCamera (Registry & registry,  Entity target, float smoothing) {
        ...
        registry.apply_component<comp::Camera>          (camera, {target, false, {0.0f, 0.0f}, smoothing, 1.0f, 4.0f, 0.4f, 1.0f}); 
        registry.apply_component<comp::Transform>       (camera,  comp::Transform({0.0f, 0.0f}) );
